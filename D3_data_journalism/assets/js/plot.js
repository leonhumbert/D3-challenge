...
// How about using a second js file only for functions????
...
//retrieve census data for each state from csv file for execution with an async function
d3.csv("./assets/data/data.csv").then(function(censusData) {
    ...
    var xLabelsGroup = chartGroup.append("g")
        .attr("transform", `translate(${width / 2}, ${height + 5 + margin.top})`);
